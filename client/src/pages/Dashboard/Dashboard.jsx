...
import SaleMovies from "../../components/Admin/AdminVentas/SaleMovies";
    ...
    <div className="w-full flex">
      <div className="w-1/5 bg-light-300 dark:bg-slate-900">
        ...
        <div className="w-3/4 p-4 flex flex-col">
            <span
              className={` w-24 my-4 text-start font-bold border-b-2 border-light-700 dark:border-dark-700 ml-2 scale-105 ${activeComponent === "adminVisitas" && "text-light-700"}`}
            >
              Suscripciones
            </span>
			...
			>
		  	...
		  	<span
              className={` w-28 my-4 text-start font-bold border-b-2 border-light-700 dark:border-dark-700 ml-2 scale-105 ${activeComponent === "adminVisitas" && "text-light-700"}`}
            >
              Visitas web
            </span>
			<button
