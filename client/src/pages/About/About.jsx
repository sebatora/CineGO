  ...
  return (
    <div className="w-full mt-28">
      ...
      <div className="w-4/5 mx-auto mt-8">
        <div className="flex flex-wrap justify-center">{teamMemberCards}</div>
      </div>
      <div className="w-full mt-1 font-medium text-gray-500 text-lg">
        ...
        <div className="flex items-center justify-center my-5">
          ...
          <Link to="https://vitejs.dev" target="_blank">
            <SiVite className="text-3xl hover:scale-110 mr-6 hover:text-yellow-400" />{" "}
          </Link>
          <Link to="https://firebase.google.com/?hl=es" target="_blank">
            <SiFirebase className="text-3xl hover:scale-110 mr-6 hover:text-orange-500" />{" "}
          </Link>
          ...
          <Link to="https://trello.com" target="_blank">
            <SiTrello className="text-3xl hover:scale-110 mr-6 hover:text-blue-800" />{" "}
          </Link>
          <Link to="https://www.figma.com/" target="_blank">
            <SiFigma className="text-3xl hover:scale-110 mr-6 hover:text-purple-700" />{" "}
          </Link>
          <Link to="https://www.mercadopago.com.ar" target="_blank">
            <SiMercadopago className="text-3xl hover:scale-110 mr-6 hover:text-blue-500" />{" "}
          </Link>
        </div>
      </div>
    </div>
