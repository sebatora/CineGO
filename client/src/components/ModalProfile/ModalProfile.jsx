...
const ModalProfile = ({ activeModal, setActiveModal }) => {
	return (
		<div className="w-72 h-40 flex flex-col top-20 right-0 bg-white dark:bg-black absolute uppercase border border-t-0 border-black dark:border-white dark:border-opacity-70 border-opacity-10 rounded-bl-md">
			<h3 className="my-4 flex justify-center select-none">!Hola Noe Gomez!</h3>
