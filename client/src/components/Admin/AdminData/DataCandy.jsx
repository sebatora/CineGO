    ...
    <>
      {loading ? (
        ...
        <div className='w-full'>
                ...
                {pagination().map((candy, index) => (
                  <tr className={`h-12 ${index % 2 === 0 ? 'bg-slate-100' : 'bg-slate-300'}`} key={index}>
                    <td className='flex justify-center'>
                      <img className='w-14 h-14' src={candy.image} alt={candy.name} />
                    </td>
                    <td>{candy.name}</td>
                    ...
                    <td>
                      ...
                      >
                        <span
                          aria-hidden='true'
                          className={`${
                            candy.activeCandy ? 'translate-x-5' : 'translate-x-0'
          ...
          {activeEdit && <EditCandy candyFound={candyFound} setActiveEdit={setActiveEdit} />}
        </div>
      )}
		</>
	)
